...
import "../../../styles/ProductTypes/Male/MaleChildren.css";
...
const filteredProdutos = produtos.filter((produto) => {
  const categoryMatch =
    ...
    produto.nome_prodmale.toLowerCase().includes(selectedCategory.toLowerCase());

  const searchMatch = produto.nome_prodmale
    .toLowerCase()
        ...
        <div className={`cart ${cartVisible ? "active" : ""}`}>
            ...
            <div className="space">
              <div className="title-section">
                <h1 className="general-title-1">MASCULINO | INFANTIL</h1>
